...
class _MainScreenState extends State<MainScreen> {
  late int _currentIndex = _lastMainTabIndex;
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) async {
        ...
        if (_currentIndex != 0) {
          setState(() {
            _currentIndex = 0;
            _lastMainTabIndex = _currentIndex;
          });
        } else {
          if (context.mounted) {
                                  ...
                                  onTap: (mediaItem) {
                                    final dummyMap = {
                                      ...
                                      'image':
                                          ...
                                          'https://ladyradio.it/wp-content/uploads/2021/01/logo-lady-radio.png',
                                      'duration': '',
                                      'date': '',
