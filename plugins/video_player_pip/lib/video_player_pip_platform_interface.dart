...
abstract class VideoPlayerPipPlatform extends PlatformInterface {
  ...
  /// Prepares PiP for the specified player ID without starting it immediately.
  Future<bool> preparePipMode(
    int playerId, {
    int? width,
    int? height,
    String? title,
    ...
    throw UnimplementedError('preparePipMode() has not been implemented.');
  }
